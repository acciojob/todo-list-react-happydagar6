  ...
  return (
    <div style={{ maxWidth: '600px', margin: '40px auto', fontFamily: 'sans-serif' }}>
      ...
      <div className="tasks_section">
        {tasks.map(task => (
          <div key={task.id} style={{ display: 'flex', alignItems: 'center', padding: '15px 0', borderBottom: '1px solid #eee' }}>
            ...
            {editId === task.id ? (
              ...
              <span className="task" style={{ flexGrow: 1, paddingLeft: '5px' }}>{task.text}</span>
            )}
